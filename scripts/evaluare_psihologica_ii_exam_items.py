"""Itemi examen — Introducere în evaluarea psihologică II."""
...
LOT_NAME = "Introducere în evaluarea psihologică II"
START_ID = 9001
...
def _load_raw():
    ...
    data_path = (
        ...
        / "data"
        / "evaluare_psihologica_ii_items.json"
    )
    if data_path.exists():
        return json.loads(data_path.read_text(encoding="utf-8"))
    from scripts.evaluare_psihologica_ii_bank_data import EVALUARE_ITEMS

    return EVALUARE_ITEMS


def build_items() -> List[Dict]:
    from scripts.evaluare_psihologica_ii_explanations import attach_explanations

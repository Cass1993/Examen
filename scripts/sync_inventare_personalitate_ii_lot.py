"""Rescrie lotul Inventare de personalitate II în questions.json din cod."""
...
from scripts.inventare_personalitate_ii_exam_items import LOT_NAME, build_items
...
def main() -> int:
    ...
    print(f"11696: {str(built[250].get('text', ''))[:70]}...")
    print(f"11725: {str(built[-1].get('text', ''))[:70]}...")
    return 0

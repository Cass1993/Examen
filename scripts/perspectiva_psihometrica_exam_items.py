"""Itemi examen — Perspectiva psihometrică."""
...
LOT_NAME = "Perspectiva psihometrică"
START_ID = 9051
...
def _load_raw():
    ...
    data_path = (
        ...
        / "data"
        / "perspectiva_psihometrica_items.json"
    )
    if data_path.exists():
        return json.loads(data_path.read_text(encoding="utf-8"))
    from scripts.perspectiva_psihometrica_bank_data import PSIHOMETRIC_ITEMS

    return PSIHOMETRIC_ITEMS


def build_items() -> List[Dict]:
    from scripts.perspectiva_psihometrica_option_polish import polish_bank_row

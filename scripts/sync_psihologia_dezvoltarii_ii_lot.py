"""Rescrie lotul Psihologia dezvoltării II în questions.json din cod."""
...
from scripts.psihologia_dezvoltarii_ii_exam_items import LOT_NAME, build_items  # noqa: E402
...
def main() -> int:
    ...
    print(f"10001: {str(built[0].get('text', ''))[:70]}...")
    print(f"10490: {str(built[-1].get('text', ''))[:70]}...")
    return 0

"""Rescrie lotul Statistică II în questions.json din cod."""
...
from scripts.statistica_ii_exam_items import LOT_NAME, build_items  # noqa: E402
...
def main() -> int:
    ...
    print(f"11245: {str(built[-1].get('text', ''))[:70]}...")
    return 0

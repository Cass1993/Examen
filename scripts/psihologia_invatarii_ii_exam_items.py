"""Itemi examen — Psihologia învățării II."""
...
LOT_NAME = "Psihologia învățării II"
START_ID = 10501


def build_items() -> List[Dict]:
    from scripts.psihologia_invatarii_ii_explanations import attach_explanations
    from scripts.psihologia_invatarii_ii_bank_data import PSIHOLOGIA_INVATARII_II_ITEMS

    raw = attach_explanations(list(PSIHOLOGIA_INVATARII_II_ITEMS))

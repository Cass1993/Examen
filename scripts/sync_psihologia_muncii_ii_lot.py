"""Rescrie lotul Psihologia muncii II în questions.json din cod."""
...
from scripts.psihologia_muncii_ii_exam_items import LOT_NAME, build_items  # noqa: E402
...
def main() -> int:
    ...
    print(f"9501: {str(built[0].get('text', ''))[:70]}...")
    print(f"9580: {str(built[-1].get('text', ''))[:70]}...")
    return 0
